...
namespace LibTriboroughBridgeChorusPlugin.Infrastructure
{
	...
	/// (specified elsewhere by the client, but which matches the retrun value of the "SupportedActionType" method.
	///
	...
	public interface IBridgeActionTypeHandler
	{
		...
		/// </summary>
		/// <param name="progress">The IProgress implementation used for all of the more general inforamtion from the brdiges and/or Chorus. Null is acceptable.</param>
