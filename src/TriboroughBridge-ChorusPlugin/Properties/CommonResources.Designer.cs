...
namespace TriboroughBridge_ChorusPlugin.Properties {
    ...
    public class CommonResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to You are importing a lexicon (LIFT) project that requires a newer version of FieldWorks. Your current version of FieldWorks uses LIFT model version {0}, and version {1} is required. Please update your version of FieldWorks..
        /// </summary>
