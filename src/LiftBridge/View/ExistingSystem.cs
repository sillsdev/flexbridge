...
// ReSharper restore EmptyGeneralCatchClause
			...
			{
				// Pull/Merge/Send(Push) is the order Chorus does it.
				// (Setting the options here has no effect on Chorus processing oprder, but it does help humans know the order.)
