...
{
	public class FlexBridgeSychronizerAdjunct : ISychronizerAdjunct
	{
		...
		public FlexBridgeSychronizerAdjunct(string fwdataPathname, string fixitPathname, bool writeVerbose)
		{
