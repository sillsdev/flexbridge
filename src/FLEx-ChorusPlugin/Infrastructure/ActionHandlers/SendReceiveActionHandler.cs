...
namespace FLEx_ChorusPlugin.Infrastructure.ActionHandlers
{
		...
		IBridgeActionTypeHandlerCallEndWork
	{
		...
		private SyncResults ShowSyncDialogAndSync(IChorusSystem chorusSystem)
		{
				...
				SyncUIFeatures.NormalRecommended | SyncUIFeatures.PlaySoundIfSuccessful))
			{
				...
				var syncAdjunt = new FlexBridgeSychronizerAdjunct(origPathname, _commandLineArgs["-f"],
		...
		public void StartWorking(Dictionary<string, string> commandLineArgs)
		{
			...
			var result = SendReceive.Run(commandLineArgs["-p"], commandLineArgs["-u"]);
