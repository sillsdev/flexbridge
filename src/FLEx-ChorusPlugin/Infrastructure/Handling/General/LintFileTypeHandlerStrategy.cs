...
namespace FLEx_ChorusPlugin.Infrastructure.Handling.General
{
	...
	/// </summary>
	internal class LintFileTypeHandlerStrategy : IFieldWorksFileHandler
	{
		...
		public IEnumerable<IChangeReport> Find2WayDifferences(FileInRevision parent, FileInRevision child, HgRepository repository)
		{
			return Xml2WayDiffService.ReportDifferences(repository, parent, child,
				null,
				"curiosity", SharedConstants.GuidStr);
		}
		...
		public void Do3WayMerge(MetadataCache mdc, MergeOrder mergeOrder)
		{
			...
			XmlMergeService.Do3WayMerge(mergeOrder,
				...
				null,
				"curiosity", SharedConstants.GuidStr, WritePreliminaryLintInformation);
		}
