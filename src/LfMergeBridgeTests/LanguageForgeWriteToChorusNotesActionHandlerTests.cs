...
namespace LfMergeBridgeTests
{
	...
	public class LanguageForgeWriteToChorusNotesActionHandlerTests
	{
		...
		{
			// Setup
			const string notesContent = @"<?xml version=""1.0"" encoding=""utf-8""?>
<notes
	version=""0"">
	<annotation
		class=""question""
		...
		guid=""e8a03b36-2c36-4647-b879-24dbcd5a9ac4"">
		<message
			...
			_inputFile = new TempFile(@"[{""Key"":""5a71f21c6efc676a612eb76f"",
""Value"":{""Id"":""5a71f21c6efc676a612eb76f"",""Guid"":""e8a03b36-2c36-4647-b879-24dbcd5a9ac4"",
...
""DateCreated"":""2018-01-31T16:43:08.474Z"",""DateModified"":""2018-01-31T16:43:08.474Z"",
""Content"":""LF comment on F"",
""Status"":""closed"",""StatusGuid"":""c9bd2519-b92a-4e65-a879-00e0c8a57e1d"",
""IsDeleted"":false,""EntryRef"":""5a3801ee511fd55d813e1f76"",""Score"":0}}]");
			string forClient = null;
			var options = new Dictionary<string, string>();
			options[LfMergeBridgeUtilities.serializedCommentsFromLfMerge] = _inputFile.Path;
...
<notes
	...
	<annotation
		...
		<message
			...
			_inputFile = new TempFile(@"[{""Key"":""5a71f21c6efc676a612eb76f"",
""Value"":{""Id"":""5a71f21c6efc676a612eb76f"",""Guid"":""e8a03b36-2c36-4647-b879-24dbcd5a9ac4"",
""AuthorInfo"":{""CreatedByUserRef"":""5a2671036efc6737ab1f1f82"",""CreatedDate"":""2018-01-31T16:43:08.474Z"",""ModifiedByUserRef"":""5a2671036efc6737ab1f1f82"",""ModifiedDate"":""2018-02-06T16:47:13Z""},
""Regarding"":{""TargetGuid"":""1e7a8774-da73-49de-83bf-a613c12bb281"",""Word"":""F"",""Meaning"":""F""},
""DateCreated"":""2018-01-31T16:43:08.474Z"",""DateModified"":""2018-02-06T16:47:13.123Z"",
""Content"":""LF comment on F"",
""Status"":""resolved"",""StatusGuid"":""c4f4df11-8dda-418e-8124-66406d67a2d1"",
""IsDeleted"":false,""EntryRef"":""5a3801ee511fd55d813e1f76"",""Score"":0}}]");
			string forClient = null;
			var options = new Dictionary<string, string>();
			options[LfMergeBridgeUtilities.serializedCommentsFromLfMerge] = _inputFile.Path;
			...
			// Verify
			Assert.That(forClient, Is.EqualTo("New comment ID->Guid mappings: \nNew reply ID->Guid mappings: "));
			Assert.That(ReadChorusNotesFile(projectDir), Is.EqualTo(@"<?xml version=""1.0"" encoding=""utf-8""?>
<notes
	version=""0"">
	<annotation
		class=""question""
...
""DateCreated"":""2018-01-31T16:43:08.474Z"",""DateModified"":""2018-02-06T16:47:13.123Z"",
""Content"":""LF comment on F"",
""Status"":""open"",""StatusGuid"":""449489a4-8e0e-4b98-a75d-b6263f4a4e6a"",
""IsDeleted"":false,""EntryRef"":""5a3801ee511fd55d813e1f76"",""Score"":0}}]");
			string forClient = null;
			var options = new Dictionary<string, string>();
			options[LfMergeBridgeUtilities.serializedCommentsFromLfMerge] = _inputFile.Path;
...
<notes
	version=""0"">
			...
			_inputFile = new TempFile(@"[{""Key"":""5a71f21c6efc676a612eb76f"",
""Value"":{""Id"":""5a71f21c6efc676a612eb76f"",
""AuthorInfo"":{""CreatedByUserRef"":""5a2671036efc6737ab1f1f82"",""CreatedDate"":""2018-01-31T16:43:08.474Z"",""ModifiedByUserRef"":""5a2671036efc6737ab1f1f82"",""ModifiedDate"":""2018-02-06T16:47:13Z""},
""Regarding"":{""TargetGuid"":""1e7a8774-da73-49de-83bf-a613c12bb281"",""Word"":""F"",""Meaning"":""F""},
""DateCreated"":""2018-01-31T16:43:08.474Z"",""DateModified"":""2018-02-06T16:47:13.123Z"",
""Content"":""LF comment on F"",
...
""IsDeleted"":false,""EntryRef"":""5a3801ee511fd55d813e1f76"",""Score"":0}}]");
			...
			// Verify
			Assert.That(forClient, Is.EqualTo("New comment ID->Guid mappings: 5a71f21c6efc676a612eb76f=1687b882-97c9-4ca0-9bc3-2a0511715400\nNew reply ID->Guid mappings: "));
			Assert.That(ReadChorusNotesFile(projectDir), Is.EqualTo(@"<?xml version=""1.0"" encoding=""utf-8""?>
<notes
	version=""0"">
	<annotation
...
</notes>")); // REVIEW: It's surprising that we ignore the DateCreated/Modified from LF
		}
	}
}
