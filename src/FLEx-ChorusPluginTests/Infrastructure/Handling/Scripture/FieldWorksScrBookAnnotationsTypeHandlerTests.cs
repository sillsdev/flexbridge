...
namespace FLEx_ChorusPluginTests.Infrastructure.Handling.Scripture
{
	...
	public class FieldWorksScrBookAnnotationsTypeHandlerTests : BaseFieldWorksTypeHandlerTests
	{
		...
		{
			base.TestSetup();
			FieldWorksTestServices.SetupTempFilesWithExtension("." + SharedConstants.bookannotations, out _ourFile, out _commonFile, out _theirFile);
		}
		...
		public void ExtensionOfKnownFileTypesShouldBeArchivedDraft()
		{
			...
			Assert.IsTrue(extensions.Contains(SharedConstants.bookannotations));
		}
