...
namespace FLEx_ChorusPluginTests.Infrastructure.Handling.Scripture.ArchivedDrafts
{
	[TestFixture]
	public class FieldWorksArchivedDraftsTypeHandlerTests : BaseFieldWorksTypeHandlerTests
	{
		...
		{
			FieldWorksTestServices.SetupTempFilesWithExtension("." + SharedConstants.ArchivedDraftExt, out _ourFile, out _commonFile, out _theirFile);
		}
		...
		public void ExtensionOfKnownFileTypesShouldBeArchivedDraft()
		{
			...
			Assert.IsTrue(extensions.Contains(SharedConstants.ArchivedDraftExt));
		}
