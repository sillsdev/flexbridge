...
namespace FLEx_ChorusPluginTests.Infrastructure.Handling.Linguistics.Phonology
{
	[TestFixture]
	public class FieldWorksPhonologyDataTypeHandlerTests : BaseFieldWorksTypeHandlerTests
	{
		...
		{
			FieldWorksTestServices.SetupTempFilesWithName(SharedConstants.PhonologicalDataFilename, out _ourFile,
		...
		public void ExtensionOfKnownFileTypesShouldBePhondata()
		{
			...
			Assert.IsTrue(extensions.Contains(SharedConstants.Phondata));
		}
		...
		public void ShouldNotBeAbleToValidateIncorrectFormatFile()
		{
			...
			{
				var newpath = Path.ChangeExtension(tempModelVersionFile.Path, SharedConstants.Phondata);
