...
{
	public static class FieldWorksTestServices
	{
		public const int ExpectedExtensionCount = 26;

		public static void RemoveTempFiles(ref TempFile ourFile, ref TempFile commonFile, ref TempFile theirFile)
		{
			ourFile.Dispose();
			ourFile = null;
		...
		public static void RemoveTempFilesAndParentDir(ref TempFile ourFile, ref TempFile commonFile, ref TempFile theirFile)
		{
		...
		public static void SetupTempFilesWithName(string filename, out TempFile ourFile, out TempFile commonFile, out TempFile theirFile)
		{
			SetupTempFilesWithName(filename, MetadataCache.MaximumModelVersion, out ourFile, out commonFile, out theirFile);
		}

		public static void SetupTempFilesWithName(string filename, int modelVersion, out TempFile ourFile, out TempFile commonFile, out TempFile theirFile)
		{
		...
		public static void SetupTempFilesWithExtension(string extension, out TempFile ourFile, out TempFile commonFile, out TempFile theirFile)
		{
		...
		public static XmlNode CreateNodes(string commonAncestor, string ourContent, string theirContent, out XmlNode theirNode, out XmlNode ancestorNode)
		{
		...
		public static XmlNode GetNode(string input)
		{
