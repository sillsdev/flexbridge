...
# [2] build: chorus-linux64-2.6 Continuous (bt323)
#     project: Chorus
#     URL: http://build.palaso.org/viewType.html?buildTypeId=bt323
#     clean: false
#     revision: latest.lastSuccessful
...
#     VCS: https://github.com/sillsdev/chorus.git [chorus-2.6]
# [3] build: chorus-linux64-2.6 Continuous (bt323)
#     project: Chorus
#     URL: http://build.palaso.org/viewType.html?buildTypeId=bt323
#     clean: false
#     revision: latest.lastSuccessful
...
#     VCS: https://github.com/sillsdev/icu-dotnet [master]
# [9] build: palaso-linux64-libpalaso-3.1 Continuous (bt322)
#     project: libpalaso
#     URL: http://build.palaso.org/viewType.html?buildTypeId=bt322
#     clean: false
#     revision: latest.lastSuccessful
#     paths: {"SIL.Core.dll*"=>"lib/ReleaseMono", "SIL.TestUtilities.dll*"=>"lib/ReleaseMono", "SIL.Windows.Forms.dll*"=>"lib/ReleaseMono", "SIL.Windows.Forms.GeckoBrowserAdapter.dll"=>"lib/ReleaseMono", "SIL.Lift.dll"=>"lib/ReleaseMono", "L10NSharp.dll"=>"lib/ReleaseMono", "debug/SIL.Core.dll*"=>"lib/DebugMono", "debug/SIL.TestUtilities.dll*"=>"lib/DebugMono", "debug/SIL.Windows.Forms.dll*"=>"lib/DebugMono", "debug/SIL.Windows.Forms.GeckoBrowserAdapter.dll*"=>"lib/DebugMono", "debug/SIL.Lift.dll*"=>"lib/DebugMono", "debug/L10NSharp.dll"=>"lib/DebugMono"}
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/SIL.Core.dll.config?branch=%3Cdefault%3E ./lib/ReleaseMono/SIL.Core.dll.config
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/SIL.Core.dll.mdb?branch=%3Cdefault%3E ./lib/ReleaseMono/SIL.Core.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/SIL.TestUtilities.dll.mdb?branch=%3Cdefault%3E ./lib/ReleaseMono/SIL.TestUtilities.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/SIL.Windows.Forms.dll.config?branch=%3Cdefault%3E ./lib/ReleaseMono/SIL.Windows.Forms.dll.config
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/SIL.Windows.Forms.dll.mdb?branch=%3Cdefault%3E ./lib/ReleaseMono/SIL.Windows.Forms.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/debug/SIL.Core.dll.config?branch=%3Cdefault%3E ./lib/DebugMono/SIL.Core.dll.config
...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt322/latest.lastSuccessful/debug/SIL.Windows.Forms.dll.config?branch=%3Cdefault%3E ./lib/DebugMono/SIL.Windows.Forms.dll.config
