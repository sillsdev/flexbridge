...
#     VCS: https://github.com/sillsdev/chorus.git [chorus-2.5]
# [3] build: chorus-linux64-chorus-2.5 Continuous (ChorusLinux64v25Cont)
#     project: Chorus
#     URL: http://build.palaso.org/viewType.html?buildTypeId=ChorusLinux64v25Cont
#     clean: false
#     revision: latest.lastSuccessful
...
#     clean: false
#     revision: latest.lastSuccessful
#     paths: {"Palaso.dll"=>"lib/ReleaseMono", "Palaso.TestUtilities.dll"=>"lib/ReleaseMono", "PalasoUIWindowsForms.dll"=>"lib/ReleaseMono", "PalasoUIWindowsForms.GeckoBrowserAdapter.dll"=>"lib/ReleaseMono", "Palaso.Lift.dll"=>"lib/ReleaseMono", "L10NSharp.dll"=>"lib/ReleaseMono"}
...
#     clean: false
#     revision: latest.lastSuccessful
#     paths: {"debug/Palaso.dll"=>"lib/DebugMono", "debug/Palaso.TestUtilities.dll"=>"lib/DebugMono", "debug/PalasoUIWindowsForms.dll"=>"lib/DebugMono", "debug/PalasoUIWindowsForms.GeckoBrowserAdapter.dll"=>"lib/DebugMono", "debug/Palaso.Lift.dll"=>"lib/DebugMono", "debug/L10NSharp.dll"=>"lib/DebugMono"}
#     VCS: https://github.com/sillsdev/libpalaso.git [libpalaso-2.6]
...
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/Autofac.dll?branch=%3Cdefault%3E ./lib/common/Autofac.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/Chorus.exe?branch=%3Cdefault%3E ./lib/ReleaseMono/Chorus.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/LibChorus.dll?branch=%3Cdefault%3E ./lib/ReleaseMono/LibChorus.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/ChorusHub.exe?branch=%3Cdefault%3E ./lib/ReleaseMono/ChorusHub.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/ChorusMerge.exe?branch=%3Cdefault%3E ./lib/ReleaseMono/ChorusMerge.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/Mercurial-i686.zip?branch=%3Cdefault%3E ./lib/ReleaseMono/Mercurial-i686.zip
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/Mercurial-x86_64.zip?branch=%3Cdefault%3E ./lib/ReleaseMono/Mercurial-x86_64.zip
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/LibChorus.TestUtilities.dll?branch=%3Cdefault%3E ./lib/ReleaseMono/LibChorus.TestUtilities.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/debug/Chorus.exe?branch=%3Cdefault%3E ./lib/DebugMono/Chorus.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/debug/LibChorus.dll?branch=%3Cdefault%3E ./lib/DebugMono/LibChorus.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/debug/ChorusHub.exe?branch=%3Cdefault%3E ./lib/DebugMono/ChorusHub.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/debug/ChorusMerge.exe?branch=%3Cdefault%3E ./lib/DebugMono/ChorusMerge.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/Mercurial-i686.zip?branch=%3Cdefault%3E ./lib/DebugMono/Mercurial-i686.zip
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/Mercurial-x86_64.zip?branch=%3Cdefault%3E ./lib/DebugMono/Mercurial-x86_64.zip
copy_auto http://build.palaso.org/guestAuth/repository/download/ChorusLinux64v25Cont/latest.lastSuccessful/debug/LibChorus.TestUtilities.dll?branch=%3Cdefault%3E ./lib/DebugMono/LibChorus.TestUtilities.dll
